...
def setup_vm(vm, params, test):
    if params.get("os_type") == "linux":
        ...
        setup_vm_windows(vm,params, test)
...
"""
    ...
    for vm in params.get("vms").split():
        ...
        setup_vm(env.get_vm(vm), env.get_vm(vm).params, test)
