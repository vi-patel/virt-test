...
def run_rv_smartcard(test, params, env):
    ...
    try:
        ...
        logging.info("remote-viewer is running " + str(pid))
    except:
    ...
    if smartcard_testtype == "pkcs11_listcerts": 
        ...
        try:
            ...
            #Expected to get a shell timeout error, listing certs prompts for PIN
            try:
        ...
        logging.info("Listing Certs available on the guest:  " + listcerts_output)
        ...
        for cert in cert_list:
            ...
            if subj_string in listcerts_output:
                ...
                raise error.TestFail(subj_string + " Not found, so TEST FAILS")
                ...
                if testindex >= 0:
                    ...
                    if testindex >= 0:
                        ...
                        if testindex3 >= 0:
                            ...
                            raise error.TestFail(certcheck1 + " not found")
                    else:
                        raise error.TestFail(subj_string + " not found")
                else:
                    raise error.TestFail(checkstr + " not found")

            #print string_aftercheck

        else:
            raise error.TestFail(searchstr + " not found")
